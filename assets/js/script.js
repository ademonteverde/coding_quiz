...
function nextQuestion() {
    for (let checkbox of checkBoxes) {
        checkbox.classList.remove('correct', 'wrong')
...
function checkAnswers() {
    for (i = 0; i < checkBoxes.length; i++) {
        checkBoxes[i].addEventListener('click', (e) => {
            ...
            const isCorrectAnswer = selectedCheckbox.nextSibling.dataset.value === quizQuestions[questionIndex].correctAnswer;
            ...
            if (isCorrectAnswer) { 
                ...
                selectedCheckbox.classList.add('wrong');
